...
+
Se esta for a sua primeira vez acessando o NetApp Backup and Recovery e você já tiver um sistema na Console, mas nenhum recurso descoberto, a página "Bem-vindo ao novo NetApp Backup and Recovery" será exibida com uma opção para *Descobrir recursos*.
