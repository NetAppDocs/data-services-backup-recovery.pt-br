...
---
= Configure os certificados de segurança para NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Se a comunicação entre os contêineres de NetApp Backup and Recovery e StorageGRID deve verificar o certificado do StorageGRID, siga as etapas abaixo.
