...
** Escolha um valor de tempo limite para o script. Se o script não for executado dentro desse período, a restauração prossegue mesmo assim.
...
** *Abra o banco de dados ou o banco de dados contêiner no modo LEITURA/GRAVAÇÃO após a recuperação*: Após a conclusão da operação de restauração, o NetApp Backup and Recovery habilita o modo LEITURA/GRAVAÇÃO para o banco de dados.
