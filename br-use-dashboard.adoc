...
---
= Visualize a integridade da proteção no painel do NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Monitore a integridade de suas cargas de trabalho para identificar problemas de proteção e responder a alertas. Visualize o status de backups e restaurações e revise os resumos de Sistema, Proteção, Tarefa e Restauração no Painel de Backup e Recuperação da NetApp.
...
Confira o número total de tarefas concluídas, em execução ou com falha no resumo de tarefas.

.Passos
. Para cada distribuição de tarefas, altere o filtro para exibir o resumo das tarefas com falha, em execução e concluídas com base no número de dias, por exemplo, os últimos 30 dias, os últimos 7 dias, as últimas 24 horas ou o último ano.
. Veja os detalhes das tarefas com falha, em execução e concluídas selecionando *Visualizar monitoramento de tarefas*.
...
Analise as seguintes informações no resumo da restauração:
