...
[role="lead"]
Exclua snapshots locais do Microsoft SQL Server do NetApp Backup and Recovery.
...
. Selecione o banco de dados cujo Snapshot você deseja excluir.
. No menu Ações, selecione *Exibir detalhes de proteção*.
. Selecione o Snapshot local que deseja excluir.
+
