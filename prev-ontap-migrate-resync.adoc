...
. Verificar a elegibilidade do volume. O sistema verifica se os volumes são elegíveis para ressincronização. Se um volume não for elegível, significa que os critérios de snapshot comuns não foram estabelecidos.
+
