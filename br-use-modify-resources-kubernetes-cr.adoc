...
*Função necessária do NetApp Console* Superadministrador de Backup and Recovery ou administrador de restauração de Backup and Recovery. link:reference-roles.html["Saiba mais sobre as funções de acesso do NetApp Backup and Recovery"]. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Saiba mais sobre as funções de acesso do NetApp Console para todos os serviços"^].
