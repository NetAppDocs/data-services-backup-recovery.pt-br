...
.. *Configurações do Hyper-V*: faça o seguinte:
+
...
... Adicione um novo host Hyper-V inserindo o FQDN ou endereço IP do host e selecionando um agente do Console e as credenciais. Se o FQDN não puder ser resolvido pelo agente do Console, use o endereço IP. Para clusters de failover, insira o endereço IP de gerenciamento do cluster.


.. *Configurações avançadas*: Opcionalmente, insira um caminho de instalação para o plug-in Hyper-V da NetApp.
