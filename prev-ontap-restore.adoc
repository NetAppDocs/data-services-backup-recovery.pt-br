...
Antes de restaurar, anote o nome do volume de origem, o sistema de origem, o SVM e a data do arquivo de backup. Você pode restaurar dados do ONTAP de uma cópia do Snapshot, de um volume replicado ou de backups armazenados no armazenamento de objetos.
