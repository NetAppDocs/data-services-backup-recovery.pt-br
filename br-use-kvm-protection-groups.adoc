...
+
As VMs que você selecionar aparecerão na área *Added virtual machines*. Você pode remover VMs individualmente da lista ou esvaziar a lista completamente. Você pode adicionar VMs de vários hosts KVM à lista.
