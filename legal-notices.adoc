...
* link:media/notice_cloud_backup_service.pdf["Aviso sobre o NetApp Backup and Recovery"^]
* link:media/notice_single_file_restore.pdf["Aviso para restauração de arquivo único"^]
