...
summary: Prepare um local externo, como o StorageGRID, AWS ou Azure, e configure as permissões necessárias para que ele possa servir como destino de backup. 
---
= Configurar os destinos de backup
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Prepare um local externo, como o StorageGRID, AWS ou Azure, e configure as permissões necessárias para que ele possa servir como destino de backup.
...
* NetApp StorageGRID.
+
Veja  https://docs.netapp.com/us-en/storage-management-storagegrid/task-discover-storagegrid.html["Descubra o StorageGRID"^].

+
Veja  https://docs.netapp.com/us-en/storagegrid/index.html["Documentação do StorageGRID"^] para obter detalhes sobre o StorageGRID.

* Amazon Web Services. Consulte https://docs.netapp.com/us-en/storage-management-s3-storage/index.html["Documentação do Amazon S3"^].
+
...
** Para obter detalhes sobre como gerenciar seu armazenamento da AWS no Console, consulte  https://docs.netapp.com/us-en/console-setup-admin/task-viewing-amazon-s3.html["Gerencie seus buckets do Amazon S3"^].


* Microsoft Azure.
+
** Veja  https://docs.netapp.com/us-en/storage-management-blob-storage/index.html["Documentação do Azure Blob storage"^].
...
Depois de configurar as opções no próprio destino de backup, você irá configurá-lo posteriormente como um destino de backup no NetApp Backup and Recovery. Para obter detalhes sobre como configurar o destino de backup no NetApp Backup and Recovery, consulte link:br-start-discover-backup-targets.html["Descubra alvos de backup"].
