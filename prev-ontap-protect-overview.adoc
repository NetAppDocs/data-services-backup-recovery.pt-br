...
| Cloud Volumes ONTAP em storage de objetos compatível com S3  a| 
* Cloud Volumes ONTAP em storage de objetos compatível com S3
* Sistema ONTAP local
...
| Storage de objetos compatível com S3  a| 
* Cloud Volumes ONTAP em storage de objetos compatível com S3
* Sistema ONTAP local
