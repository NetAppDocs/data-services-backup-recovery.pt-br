...
* Restaurar de um backup de storage de objetos (somente para o local original)



NOTE: A restauração a partir de backup de armazenamento de objetos não é compatível com máquinas virtuais que residem em armazenamento SAN.
...
* Restaurar para um local alternativo (a partir do storage primário e secundário)
