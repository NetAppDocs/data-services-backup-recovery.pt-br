...
* NFSv3, NFSv4.1 e os datastores VMFS são suportados.
...
* VMware TLS: 1.2, 1.3
* Armazenamento conectado compatível:
+
...
*** Certifique-se de que o usuário faça parte da política de segurança local "Fazer logon como serviço".
