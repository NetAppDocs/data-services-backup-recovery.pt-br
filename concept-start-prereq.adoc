...
* ASP.NET Core Runtime 8.0.23 Hosting Bundle (e todos os patches 8.0.x subsequentes)
* PowerShell 7.4.13
...
*Requisitos de software para o host Windows Server Hyper-V*
...
| ASP.NET Core Runtime | Pacote de hospedagem 8.0.23 (e todos os patches 8.0.x subsequentes) 
...
* ONTAP 9.13.1 ou posterior
* Amazon FSx for NetApp ONTAP storage systems executando a versão 9.13.1 ou posterior
* Armazenamento SAN (prévia) (compatível com backups e restauração para o local original a partir do storage primário e secundário)
