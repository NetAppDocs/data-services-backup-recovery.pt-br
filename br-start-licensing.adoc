...
* Se você estiver usando o Backup and Recovery com NetApp Console, poderá assinar a licença de pagamento conforme o uso (PAYGO) ou adquirir uma licença bring-your-own-license (BYOL).
...
Configure o licenciamento para o NetApp Backup and Recovery.
...
=== Utilize um contrato anual com licenças de marketplace ou BYOL (Bring Your Own License)
...
== Configure o licenciamento para o NetApp Backup and Recovery implantação local

Configure o licenciamento para a versão local do NetApp Console.
...
Você usa a implantação local do NetApp Console para gerenciar licenças BYOL. Você pode adicionar novas licenças, atualizar licenças existentes e visualizar o status das licenças no Console.
