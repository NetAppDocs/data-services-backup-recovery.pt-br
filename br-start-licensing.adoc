...
[role="lead"]
Dependendo se você estiver usando o NetApp Console ou o NetApp Console (implantação local), você pode licenciar o NetApp Backup and Recovery adquirindo uma assinatura de pagamento conforme o uso (PAYGO) ou uma assinatura anual do marketplace para *NetApp Intelligent Services* do seu provedor de nuvem, ou adquirindo uma licença bring-your-own-license (BYOL) da NetApp. Uma licença válida é necessária para ativar o NetApp Backup and Recovery em um sistema, para criar backups dos seus dados de produção e para restaurar dados de backup em um sistema de produção.
...
Você usa o NetApp Console ou a implantação local do Console para gerenciar licenças BYOL. Você pode adicionar novas licenças, atualizar licenças existentes e visualizar o status das licenças a partir do Console.
