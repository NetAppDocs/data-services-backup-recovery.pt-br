...
* Testado e validado com Wasabi storage de objetos; clientes também relataram implantações bem-sucedidas com MinIO, IBM Cloud Object Storage e Apple Object Store
