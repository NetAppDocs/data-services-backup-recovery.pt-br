...
+
*** *Alterar local de armazenamento padrão*: Habilite esta opção para restaurar um backup de armazenamento de objetos em uma VM de armazenamento diferente caso o local de armazenamento de origem esteja inacessível ou cheio. Escolha um cluster, VM de armazenamento ou agregado diferente para usar.
