...
---
= Gerencie as opções de backup para armazenamento de objetos em NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Para obter detalhes sobre as opções de proteção Datalock e Ransomware, consulte link:prev-ontap-policy-object-options.html["Opções de bloqueio de dados e proteção contra ransomware"].
