...
* *Cargas de trabalho VMware (com nova interface de usuário sem SnapCenter Plug-in para VMware vSphere)*:
+
** Proteja suas VMs e armazenamentos de dados VMware com o NetApp Backup and Recovery.
** Faça backup das cargas de trabalho do VMware para Amazon Web Services S3 ou StorageGRID.
...
* Microsoft Azure Blob (não disponível para cargas de trabalho VMware)
* StorageGRID
* ONTAP S3 (não disponível para cargas de trabalho VMware)
