...
[role="lead"]
No NetApp Backup and Recovery, crie suas próprias políticas de backup do VMware que determinam a frequência do backup, o tempo de backup e o número de arquivos de backup que são retidos.
