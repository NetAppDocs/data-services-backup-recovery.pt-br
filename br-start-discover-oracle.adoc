...
.. Escolha se deseja permitir que o NetApp Backup and Recovery instale o plug-in automaticamente ou ignorar a instalação (você precisará instalar o plug-in manualmente no host).
