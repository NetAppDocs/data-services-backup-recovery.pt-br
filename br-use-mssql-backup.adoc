...
*Função necessária do NetApp Console*: Visualizador de armazenamento, superadministrador de Backup and Recovery, administrador de backup do Backup and Recovery ou administrador de restauração do Backup and Recovery. Se você estiver protegendo dados armazenados em um cluster do Cloud Volumes ONTAP, a função de administrador do Cloud Volumes ONTAP também é necessária. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Saiba mais sobre as funções de acesso do NetApp Console para todos os serviços"^].
