...
.Passos
. Na guia *Volumes*, identifique o volume no qual deseja ativar os backups e selecione o menu Ações. image:icon-action.png["Ícone de ações"] Ao final da linha, selecione *Ativar proteção 3-2-1*.
...
+
Se você habilitou _Datalock and Ransomware protection_ para backups em nuvem na política de backup ao ativar NetApp Backup and Recovery para este cluster, você verá apenas outras políticas que foram configuradas com DataLock. E se você não habilitou _Datalock and Ransomware protection_ ao ativar NetApp Backup and Recovery, você verá apenas outras políticas de backup em nuvem que não têm DataLock configurado.
...
[NOTE]
====
* Se você habilitou _Datalock and Ransomware protection_ na política inicial ao ativar NetApp Backup and Recovery para este cluster, todas as políticas que você editar deverão ser configuradas com a mesma configuração DataLock (Governance ou Compliance). E se você não habilitou _Datalock and Ransomware protection_ ao ativar NetApp Backup and Recovery, não poderá habilitar DataLock agora.
...
.Passos
. No menu *Volumes*, clique image:icon-actions-horizontal.gif["Mais ícone"] para o volume de origem e selecione *Gerenciar backups > Exibir backup*.
+
