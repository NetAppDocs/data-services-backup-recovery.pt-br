...
[role="lead"]
Monte um ponto de recuperação do Oracle Database quando você precisar acessar o banco de dados em um estado controlado para operações de recuperação. Se a catalogação automática estiver desativada, você pode catalogar manualmente os metadados do ponto de recuperação no catálogo de recuperação do RMAN.
...
== Desmontar um ponto de recuperação do Oracle Database
...
== Catalogar um ponto de recuperação do Oracle Database
