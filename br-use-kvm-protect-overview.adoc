...
---
= Fluxo de trabalho de proteção KVM com a NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Proteja suas máquinas virtuais KVM gerenciadas e pools de storage com o NetApp Backup and Recovery. O serviço oferece operações de backup e restauração rápidas, com uso eficiente de espaço, consistentes com falhas e consistentes com a máquina virtual.

Seus hosts KVM e máquinas virtuais precisam ser gerenciados por uma plataforma como o Apache CloudStack antes que você possa protegê-los com o NetApp Backup and Recovery.
...
* Utilizar diferentes tipos de mídia ajuda você a se recuperar caso um tipo falhe.
* Você pode restaurar rapidamente a partir da cópia local e usar as cópias externas se a cópia local estiver comprometida.


Você pode usar o NetApp Backup and Recovery para executar as seguintes tarefas para cargas de trabalho KVM:
